...
(function(e) {
    var t, i, n, a, o, r, s, l = "Close", c = "BeforeAppend", d = "MarkupParse", p = "Open", u = "Change", f = "mfp", m = "." + f, g = "mfp-ready", v = "mfp-removing", h = "mfp-prevent-close", C = function() {}, y=!!window.jQuery, w = e(window), b = function(e, i) {
        t.ev.on(f + e + m, i)
    }, I = function(t, i, n, a) {
    ...
    C.prototype = {
        ...
        open: function(i) {
            ...
            t.types = [], r = "", t.ev = i.mainEl || a, i.key ? (t.popupsCache[i.key] || (t.popupsCache[i.key] = {}), t.currTemplate = t.popupsCache[i.key]) : t.currTemplate = {}, t.st = e.extend(!0, {}, e.magnificPopup.defaults, i), t.fixedContentPos = "auto" === t.st.fixedContentPos?!t.probablyMobile : t.st.fixedContentPos, t.bgOverlay || (t.bgOverlay = I("bg").on("click" + m, function() {
                t.close()
            }), t.wrap = I("wrap").attr("tabindex", -1).on("click" + m, function(e) {
                E(e.target) && t.close()
            ...
            x("BeforeOpen"), t.st.closeBtnInside ? (b(d, function(e, t, i, n) {
                ...
                height: a.height(),
                position: "absolute"
            }), a.on("keyup" + m, function(e) {
                27 === e.keyCode && t.close()
            }), w.on("resize" + m, function() {
                t.updateSize()
            }), t.st.closeOnContentClick || (r += " mfp-auto-cursor"), r && t.wrap.addClass(r);
            var f = t.wH = w.height(), v = {};
            ...
            t.isIE7 && (C += " mfp-ie7"), C && t._addClassToMFP(C), t.updateItemHTML(), x("BuildControls"), n.css(v), t.bgOverlay.add(t.wrap).prependTo(document.body), t._lastFocusedEl = document.activeElement, setTimeout(function() {
                t.content ? (t._addClassToMFP(g), k()) : t.bgOverlay.addClass(g), a.on("focusin" + m, function(i) {
                    return i.target === t.wrap[0] || e.contains(t.wrap[0], i.target) ? void 0 : (k(), !1)
                })
            }, 16), t.isOpen=!0, t.updateSize(f), x(p)
        },
        close: function() {
            t.isOpen && (t.isOpen=!1, t.st.removalDelay&&!t.isLowIE ? (t._addClassToMFP(v), setTimeout(function() {
                t._close()
        ...
        _close: function() {
            x(l);
            var i = v + " " + g + " ";
            if (t.bgOverlay.detach(), t.wrap.detach()
                , t.container.empty(), t.st.mainClass && (i += t.st.mainClass + " "), t._removeClassFromMFP(i), t.fixedContentPos) {
                var o = {
                    paddingRight: 0
                };
                t.isIE7 ? e("body, html").css("overflow", "auto") : o.overflow = "visible", n.css(o)
            }
        ...
        updateItemHTML: function() {
            ...
            if (x("BeforeChange", [t.currItem ? t.currItem.type: "", n]), t.currItem = i, !t.currTemplate[n]) {
                ...
                x("FirstMarkupParse", a), t.currTemplate[n] = a ? e(a) : !0
            }
        ...
        appendContent: function(e, i) {
            t.content = e, e ? t.st.closeBtnInside && t.currTemplate[i]===!0 ? t.content.find(".mfp-close").length || t.content.append(S()) : t.content = e : t.content = "", x(c), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(i) {
            ...
            return n.type = a || t.st.type || "inline", n.index = i, n.parsed=!0, t.items[i] = n, x("ElementParse", n), t.items[i]
        },
        ...
        _hasScrollBar: function(e) {
            return document.body.clientHeight > (e || w.height())?!0 : !1
        },
        ...
        if ("string" == typeof i)
            if ("open" === i) {
                var a, o = y ? n.data("magnificPopup"): n[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
            ...
            y ? n.data("magnificPopup", i) : n[0].magnificPopup = i, t.addGroup(n, i);
        return n
    };
    var T, M, O, _ = "inline", z = function() {
        O && (M.after(O.addClass(T)).detach(), O = null)
    };
        ...
        proto: {
            ...
            getInline: function(i, n) {
                if (z(), i.src) {
                    ...
                    return o.length ? (null !== o[0].parentNode && (M || (T = a.hiddenClass, M = I(T), T = "mfp-" + T), O = o.after(M).detach().removeClass(T)), t.updateStatus("ready")) : (t.updateStatus("error", a.tNotFound), o = e("<div>")), i.inlineElement = o, o
                }
                return t.updateStatus("ready"), t._parseMarkup(n, {}, i), n
            }
        }
    });
    var B, F = "ajax", H = function() {
        B && n.removeClass(B)
    };
    e.magnificPopup.registerModule(F, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(F), B = t.st.ajax.cursor, b(l + "." + F, function() {
                    H(), t.req && t.req.abort()
                })
            },
            getAjax: function(i) {
                ...
                var a = e.extend({
                    ...
                    success: function(n, a, o) {
                        x("ParseAjax", o), t.appendContent(e(o.responseText), F), i.finished=!0, H(), k(), setTimeout(function() {
                            t.wrap.addClass(g)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                ...
                t.types.push("image"), b(p + i, function() {
                    "image" === t.currItem.type && e.cursor && n.addClass(e.cursor)
                }), b(l + i, function() {
                    e.cursor && n.removeClass(e.cursor), w.off("resize" + m)
            ...
            findImageSize: function(e) {
                var i = 0, n = e.img[0], a = function(o) {
                    L && clearInterval(L), L = setInterval(function() {
                        return n.naturalWidth > 0 ? (t._onImageHasSize(e), void 0) : (i > 200 && clearInterval(L), i++, 3 === i ? a(10) : 40 === i ? a(50) : 100 === i && a(500), void 0)
                    }, o)
                };
                a(1)
            },
            getImage: function(i, n) {
                var a = 0, o = function() {
                    i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize=!0, i.loaded=!0) : (a++, 200 > a ? setTimeout(o, 100) : r()))
                }, r = function() {
    ...
    var j = "iframe", N = "//about:blank", W = function(e) {
        if (t.currTemplate[j]) {
    ...
    e.magnificPopup.registerModule(j, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(j), b("BeforeChange", function(e, t, i) {
                    t !== i && (t === j ? W() : i === j && W(!0))
                }), b(l + "." + j, function() {
                    W()
                })
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction=!0, i && i.enabled ? (r += " mfp-gallery", b(p + n, function() {
                ...
                }), b(d + n, function(e, n, a, o) {
                    var r = t.items.length;
                    a.counter = r > 1 ? Y(i.tCounter, o.index, r) : ""
                }), b("BuildControls" + n, function() {
                    if (t.items.length > 1 && i.arrows&&!t.arrowLeft) {
                        var n = i.arrowMarkup, a = t.arrowLeft = e(n.replace("%title%", i.tPrev).replace("%dir%", "left")).addClass(h), r = t.arrowRight = e(n.replace("%title%", i.tNext).replace("%dir%", "right")).addClass(h), s = o ? "mfpFastClick": "click";
                        a[s](function() {
                            t.prev()
                        }), r[s](function() {
                            t.next()
                        }), t.isIE7 && (I("b", a[0], !1, !0), I("a", a[0], !1, !0), I("b", r[0], !1, !0), I("a", r[0], !1, !0)), t.container.append(a.add(r))
                    }
                }), b(u + n, function() {
                ...
                for (e = 1; (t.direction ? a : n) >= e; e++)
                    t._preloadItem(t.index + e);
                for (e = 1; (t.direction ? n : a) >= e; e++)
                    t._preloadItem(t.index - e)
    ...
    e.magnificPopup.registerModule(q, {
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    ...
                    i = isNaN(i) ? i() : i, i > 1 && (b("ImageHasSize." + q, function(e, t) {
                        t.img.css({
                            "max-width": t.img[0].naturalWidth / i,
                            width: "100%"
                        })
                    }), b("ElementParse." + q, function(t, n) {
        ...
        e.fn.mfpFastClick = function(a) {
            return e(this).each(function() {
                ...
                if (i) {
                    ...
                    s.on("touchstart" + o, function(e) {
                        p=!1, f = 1, u = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0], c = u.clientX, d = u.clientY, w.on("touchmove" + o, function(e) {
            ...
            e(this).off("touchstart" + o + " click" + o), i && w.off("touchmove" + o + " touchend" + o)
        }
    }()
